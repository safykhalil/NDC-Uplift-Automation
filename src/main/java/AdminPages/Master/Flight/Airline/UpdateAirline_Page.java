...
public class UpdateAirline_Page {
    public UpdateAirline_Page(SHAFT.GUI.WebDriver driver) {
        this.driver = driver;
    }
    ...
    By Btn_SendForApproval = By.xpath("(//button[@class=\"col-sm-6 col-md-3 col-lg-2 mx-0 sm:mx-3 my-3 sm:my-0 p-element justify-content-center p-ripple send p-button p-component ng-star-inserted\"])[2]");
    By Txt_Remarks = By.xpath("//textarea[@placeholder=\"remarks...\"]");
    public void setEditAirline(){
    ...
    public void AirlineDetails(String airlinecode,String airlinename,String alliance,String airlinetype,String networktype){
        ...
        By option1 = By.xpath(String.format("//span[contains(text(), '%s')]", alliance));
        driver.element().click(option1);
//        driver.element().click(Lst_AirlineType);
//        By option2 = By.xpath(String.format("//span[contains(text(), '%s')]", airlinetype));
//        driver.element().click(option2);
//        driver.element().click(Lst_NetworkType);
//        By option3 = By.xpath(String.format("//span[contains(text(), '%s')]", networktype));
//        driver.element().click(option3);
    ...
    public void SendForApproval(String remarks){
